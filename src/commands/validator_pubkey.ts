...
export async function generateValidatorPubkeyProof(validatorIndexStr: string, opts: ValidatorProofOpts, program: Command) {
  ...
  // 0110010110000000000000000000010001011010111101101100
  // 011
  // 011001011
  // 0110101100000000000000000000100010110101111011011
  // 011010110000000000000000000010001011010111101101100
